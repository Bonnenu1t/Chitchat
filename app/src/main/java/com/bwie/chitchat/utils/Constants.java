...
//
    ...
    public static  String LOGIN_ACTION = "http://qhb.2dyt.com/MyInterface/userAction_login.action" ;
    public static  String REGISTER_ACTION = "http://qhb.2dyt.com/MyInterface/userAction_add.action" ;
